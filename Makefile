...
EXECUTER = $(EXEC_DIR)/find_path.c $(EXEC_DIR)/cmd_i.c $(EXEC_DIR)/cmd_ii.c $(EXEC_DIR)/redirect.c $(EXEC_DIR)/redirect_execute.c $(EXEC_DIR)/pipe.c $(EXEC_DIR)/here_doc_i.c \
